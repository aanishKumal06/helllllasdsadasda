    ...
    <div class="container">
      ...
      <div class="rules-container">
        <div class="rule-section">
         ...
         <p> Marshmallow Haven is a modern student hostel built to provide a safe, comfortable, and well-managed living space for students. Located just 5 minutes from campus, we combine convenience with a strong focus on safety, discipline, and community.

We understand the importance of a supportive environment during your academic years. That’s why our hostel is equipped with 24/7 security, biometric entry, and CCTV surveillance to ensure your safety at all times.

Our facilities include high-speed WiFi, study rooms, fully equipped kitchens, and relaxing common areas—everything you need for both productivity and comfort.

We follow clear hostel rules and a fair policy structure that encourages personal responsibility, cleanliness, and mutual respect. Ragging, smoking, alcohol, and other prohibited activities are not tolerated to maintain a peaceful environment for all.

To make your stay hassle-free, we use a digital hostel management system. Students can apply online, check room availability, view fee structures, and receive updates—all in one place.

At Marshmallow Haven, you're not just getting a room—you're joining a community that values discipline, safety, and student well-being.

Let me know if you’d like to personalize this further with your logo, contact info, or social media links.
