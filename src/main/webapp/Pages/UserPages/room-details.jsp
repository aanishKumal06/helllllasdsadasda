...
<jsp:include page="/Pages/UserPages/Components/navbar.jsp"/>
	...
	<c:if test="${not empty param.roomId}">
		...
		<div style="display: flex; justify-content: left; gap: 20px;">
		  ...
		  <form class="form-actions" action="${pageContext.request.contextPath}/ApplicationEligibilityServlet" method="get">
		    <input type="hidden" name="roomId" value="${room.roomId}">
		    <button type="submit" class="btn">Apply Now</button>
		  </form>
		
		  <form class="form-actions" action="${pageContext.request.contextPath}/Pages/AdminPages/ApplicationEligibilityServlet" method="get">
		    <input type="hidden" name="roomId" value="${room.roomId}">
